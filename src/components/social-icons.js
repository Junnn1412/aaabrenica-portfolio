...
// Footer redesign — GitHub, LinkedIn, and Facebook brand marks. Deliberately separate
...
// LinkedIn/Facebook are brand-specific graphics (CLAUDE.md: "approved local SVGs for
...
// (https://simpleicons.org, CC0-1.0), simple-icons npm package v16.28.0,
...
// Facebook was fetched and independently cross-checked 2026-08-21 against
// raw.githubusercontent.com/simple-icons/simple-icons/16.28.0/icons/facebook.svg;
// that pinned package's package.json and LICENSE.md both identify CC0-1.0.
// Reproduced verbatim — do not hand-edit these strings; if Simple Icons
// revises a mark, replace the whole value from the source, not a
// partial edit.
...
// Closed set — only the three brand marks this footer needs. Unknown keys
...
export function renderSocialIcon(name, { className = '' } = {}) {
  ...
  return `<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"${classAttr}><path d="${d}"></path></svg>`;
}
