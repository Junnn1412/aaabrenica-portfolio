...
test('brand link uses site.siteName and points to /, with no mark when site.brandMark is absent', () => {
  ...
  assert.match(
    html,
    /<a class="site-header__brand" href="\/"><span class="site-brand__text">Antonio Abrenica<\/span><\/a>/,
  );
...
// accessible name ("Antonio Abrenica"), never a second one from the image.
test('renders the brand mark decoratively, inside the same link as the visible text, when site.brandMark is present', () => {
  ...
  assert.match(
    html,
    /<a class="site-header__brand" href="\/"><img class="site-brand__mark" src="\/images\/brand\/aaa-placeholder-logo\.png" alt="" width="96" height="96"><span class="site-brand__text">Antonio Abrenica<\/span><\/a>/,
  );
...
// height, decorative alt, visible "Antonio Abrenica" text still present,
...
test('the real site.brandMark config renders correctly through renderHeader', () => {
  ...
  assert.match(
    html,
    /<a class="site-header__brand" href="\/"><img class="site-brand__mark" src="\/images\/brand\/aaa-placeholder-logo\.png" alt="" width="231" height="140"><span class="site-brand__text">Antonio Abrenica<\/span><\/a>/,
  );
  assert.equal([...html.matchAll(/site-header__brand"/g)].length, 1);
  assert.equal([...html.matchAll(/site-brand__mark/g)].length, 1);
